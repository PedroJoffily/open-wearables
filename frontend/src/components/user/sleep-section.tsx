...
function SleepStagesBar({
  ...
  if (stageData.length === 0) {
    return (
      <div className={`h-2 bg-secondary-hover rounded-full ${className}`}>
        <div className="h-full w-full bg-foreground-muted rounded-full" />
      </div>
    );
  }
  ...
  return (
    <div
      className={`h-2 bg-secondary-hover rounded-full overflow-hidden flex ${className}`}
    >
      {stageData.map(
        (stage) =>
          stage.pct > 0 && (
...
function SleepSessionRow({
  ...
  return (
    <div className="border border-border rounded-lg overflow-hidden bg-secondary/30 hover:bg-card transition-colors">
          ...
          <div className="flex items-center justify-around">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-foreground-muted">Efficiency</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-foreground-muted">Bedtime</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-foreground-muted">Wake</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {isExpanded && (
        <div className="px-4 pb-4 pt-2 border-t border-border space-y-4">
          ...
          <div>
            <h4 className="text-xs font-medium text-foreground-secondary mb-3 uppercase tracking-wider">
  ...
  return (
    <div className="space-y-3">
      {[1, 2, 3, 4, 5].map((i) => (
        <div
          key={i}
          className="px-4 py-3 border border-border rounded-lg bg-secondary/30"
        >
            ...
            <div className="space-y-6">
              ...
              {stats.stages && stats.stagesTotal > 0 && (
                <div className="p-4 border border-border rounded-lg bg-secondary/30">
                  <h4 className="text-xs font-medium text-foreground-secondary mb-4 uppercase tracking-wider">
