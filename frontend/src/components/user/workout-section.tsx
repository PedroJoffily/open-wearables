          ...
          <div className="flex-1 flex items-center justify-around">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-foreground-muted">Avg HR</p>
              </div>
            </div>
          </div>
          ...
          {summaryLoading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="p-4 border border-border rounded-lg bg-secondary/30">
                ...
                <p className="text-xs text-foreground-muted mt-1">Workouts</p>
              </div>
              ...
              <div className="p-4 border border-border rounded-lg bg-secondary/30">
                ...
                <p className="text-xs text-foreground-muted mt-1">Total Time</p>
              </div>
              ...
              <div className="p-4 border border-border rounded-lg bg-secondary/30">
                ...
                <p className="text-xs text-foreground-muted mt-1">Calories</p>
              </div>
              ...
              <div className="p-4 border border-border rounded-lg bg-secondary/30">
                ...
                <p className="text-xs text-foreground-muted mt-1">Distance</p>
              </div>
            </div>
          ) : (
